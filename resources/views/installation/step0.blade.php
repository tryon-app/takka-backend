...
@section('content')
    ...
    <div class="pb-2 px-2 px-sm-5 mx-xl-4">
        <div class="progress cursor-pointer" role="progressbar" aria-label="Demandium Software Installation"
            ...
            <div class="progress-bar width-p-0"></div>
        </div>
    </div>

    <div class="card mt-4">
        <div class="p-4 my-md-3 mx-xl-4 px-md-5">
            <p class="text-center mb-4 top-info-text">{{translate('Before starting the installation process please collect this information. Without this information, you won’t be able to complete the installation process')}}</p>

            <div class="bg-light p-4 rounded mb-4">
                <div class="d-flex justify-content-between gap-1 align-items-center flex-wrap mb-4 pb-sm-3">
                    <h6 class="fw-bold text-uppercase fs m-0 letter-spacing fs-14px">Required
            ...
            <div class="text-center">
                ...
                <a href="{{ route('step1',['token'=>bcrypt('step_1')]) }}" class="btn btn-dark px-sm-5">{{translate('Get Started')}}</a>
            </div>
        </div>
    </div>
@endsection
