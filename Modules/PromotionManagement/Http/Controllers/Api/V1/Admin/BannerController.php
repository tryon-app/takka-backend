...
class BannerController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $banner->banner_image = file_uploader('banner/', APPLICATION_IMAGE_FORMAT, $request->file('banner_image'));
        $banner->is_active = 1;
        $banner->save();
    ...
    public function update(Request $request, string $id): JsonResponse
    {
        ...
        $banner->resource_type = $request['resource_type'];
        $banner->resource_id = $request['resource_id'];
        $banner->banner_image = file_uploader('banner/', APPLICATION_IMAGE_FORMAT, $request->file('banner_image'), $banner->banner_image);
        $banner->save();
