...
<head>
    ...
    <title>{{translate('Account Unsuspend')}}</title>
...
<div class="box">
    <div class="top-wrap-box">
        ...
        <h3 style="margin-top: 20px">{{translate('Account Unsuspend')}} !</h3>
        <h5>{{translate('Hi')}} {{$provider?->company_name}},</h5>
        <p>{{translate('Congratulations! Your account has been successfully Unsuspend. We appreciate your co-operation in resolving this issue. Thank you for your understanding and patience.')}}
            .</p>
        <p>{{translate('Click here to login to your account')}}</p>
        <a href="{{route('provider.auth.login')}}">{{url('provider/auth/login')}}</a>
