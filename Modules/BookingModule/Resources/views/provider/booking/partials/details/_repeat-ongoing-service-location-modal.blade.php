<div class="modal fade" id="repeatServiceLocationModal--{{$booking['id']}}" tabindex="-1"
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <form action="{{route('provider.booking.repeat.change-service-location', [$booking['id']])}}" method="POST">
            @csrf
                                ...
                                @endif
                                    <div class="media-body d-flex justify-content-between">
                                        <div>
                                            <h5 class="c1 mb-3">
                                                @if (!$booking?->is_guest && $booking?->customer)
                                                    <span class="c1 updated_customer_name">{{ Str::limit($name, 30) }}</span>
                                                @else
                                                    <span class="updated_customer_name">{{ Str::limit($name ?? '', 30) }}</span>
                                                @endif
                                            </h5>
                                            <ul class="list-info">
                                                @if ($phone)
                                                    <li>
                                                        ...
                                                        <a href="tel:{{ $phone }}" id="updated_customer_phone">{{ $phone }}</a>
                                                    </li>
                                                @endif
                                                    <li>
