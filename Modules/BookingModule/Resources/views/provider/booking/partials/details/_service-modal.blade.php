                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <div class="d-flex gap-3 justify-content-end mb-4">
                            <button type="reset" class="btn btn--secondary edit-service-reset-btn">{{translate('reset')}}</button>
                        ...
                        <table class="table text-nowrap align-middle mb-0" id="service-edit-table">
                            ...
                            @foreach($booking->detail as $key=>$detail)
                                <tr id="service-row--{{$detail?->variant_key}}">
                                    ...
                                    <td>
                                        <input type="text" min="1" name="qty[]" class="form-control text-center" style="width: 100px"
