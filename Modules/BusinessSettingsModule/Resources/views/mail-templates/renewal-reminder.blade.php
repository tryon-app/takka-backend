...
<head>
    ...
    <title>{{translate('Subscription Renewal Reminder')}}</title>
...
<body style="background-color: #fff;">
    <div class="box">
        <div class="top-wrap-box">
            ...
            <h3 style="margin-top: 20px">{{translate('Your Subscription is About to End')}} !</h3>
            <h5>{{translate('Hi')}} {{$provider?->company_name}},</h5>
            <p>{{translate('We wanted to remind you that your subscription with') }} {{(business_config('business_name', 'business_information'))->live_values }} {{ translate('is about to end.') }}
                .</p><br><br>
            <p>{{translate('Please take a moment to review your subscription and renew to continue enjoying uninterrupted access to our services.')}}</p>
        </div>
