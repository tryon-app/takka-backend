...
<head>
    ...
    <title>{{translate('Commission To Subscription')}}</title>
...
<div class="box">
    <div class="top-wrap-box">
        ...
        <h3 style="margin-top: 20px">{{translate('Commission To Subscription')}} !</h3>
        <h5>{{translate('Hi')}} {{$provider?->company_name}},</h5>
        <p>{{translate('Your Commission To Subscription has been shifted successfully!')}}
            .</p><br><br>
        <p>{{translate('Click here to visit your panel')}}</p>
