...
<head>
    ...
    <title>{{translate('Purchase Subscription')}}</title>
...
<div class="box">
    <div class="top-wrap-box">
        ...
        <h5>{{translate('Hi')}} {{$provider?->company_name}},</h5>
            <p>{{translate('Congratulations! Your subscription plan has been successfully subscribed. You now have access to all the premium features included in your selected plan.')}}
                .</p><br><br>
            <p>{{translate('Attached to this email, you will find your subscription invoice for your records.')}}</p>
            <button class="btn"><a style="color: #fff" href="{{route('provider.public.subscription-package.transactions.download')}}?provider_user_id={{$provider->user_id}}">{{translate('Files.xlsx')}}</a></button>
