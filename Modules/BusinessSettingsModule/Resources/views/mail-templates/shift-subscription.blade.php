...
<head>
    ...
    <title>{{translate('Subscription Plan Shifted')}}</title>
...
<div class="box">
    <div class="top-wrap-box">
        ...
        <h3 style="margin-top: 20px">{{translate('Subscription Plan Shifted')}} !</h3>
        <h5>{{translate('Hi')}} {{$provider?->company_name}},</h5>
        <p>{{translate('Your subscription has been shifted successfully!')}}
            .</p><br><br>
