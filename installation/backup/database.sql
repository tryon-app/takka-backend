...
('070c766c-d777-11ed-96f4-0c7a158e4469', '2factor', '{\"gateway\":\"2factor\",\"mode\":\"live\",\"status\":\"0\",\"api_key\":\"data\",\"otp_template\":\"OTP1\"}', '{\"gateway\":\"2factor\",\"mode\":\"live\",\"status\":\"0\",\"api_key\":\"data\",\"otp_template\":\"OTP1\"}', 'sms_config', 'live', 0, NULL, '2026-02-05 10:33:56', NULL),
...
CREATE TABLE `bookings` (
  ...
  `service_location` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'customer' COMMENT 'customer,provider',
  `service_address_location` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Table structure for table `booking_ignores`
--
...
CREATE TABLE `booking_offline_payments` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `booking_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `offline_payment_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `payment_status` enum('pending','denied','approved') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'approved',
...
--
-- Table structure for table `booking_repeats`
--
...
CREATE TABLE `booking_repeats` (
  ...
  `readable_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `booking_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `booking_details_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `provider_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `serviceman_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `booking_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `transaction_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `booking_status` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `service_schedule` datetime DEFAULT NULL,
  `is_paid` tinyint(1) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `booking_repeat_details`
--
...
--
-- Table structure for table `booking_repeat_histories`
--
...
--
-- Table structure for table `business_page_settings`
--
...
--
-- Dumping data for table `business_page_settings`
--

INSERT INTO `business_page_settings` (`id`, `page_key`, `title`, `content`, `image`, `is_active`, `is_default`, `created_at`, `updated_at`) VALUES
('0b1bab0b-c404-4027-bffc-6f6ddda9a880', 'about-us', 'about us', '<p>Test About Us</p>', NULL, 1, 1, '2025-08-23 16:10:54', '2025-08-23 16:10:54'),
('1fe7b0bb-902b-40c3-8a12-319ab461c424', 'terms-and-conditions', 'terms and conditions', '<p>Test Terms & Conditions</p>', NULL, 1, 1, '2025-08-23 16:10:54', '2025-08-23 16:10:54'),
('390bda7b-bac1-454f-be34-9c1642003948', 'privacy-policy', 'privacy policy', '<p>Test Privacy Policy</p>', NULL, 1, 1, '2025-08-23 16:10:54', '2025-08-23 16:10:54'),
('79a111bc-8b84-46b8-96e9-aa17352db185', 'cancellation-policy', 'cancellation policy', '<p>Test Cancellation Policy</p>', NULL, 1, 1, '2025-08-23 16:10:54', '2025-08-23 16:10:54'),
('a59cb2a5-58fb-42e8-b4f3-1726da610eb3', 'refund-policy', 'refund policy', '<p>Test Refund Policy</p>', NULL, 1, 1, '2025-08-23 16:10:54', '2025-08-23 16:10:54');
...
('0d4fea8e-aafd-4fc1-8698-0069e2005b72', 'booking_notification_type', '\"manual\"', NULL, 'business_information', 'live', 1, '2024-10-08 12:42:37', '2024-10-08 12:42:37'),
('0d9bcbac-b423-4052-914a-ede9e7a19197', 'booking_notification', '1', NULL, 'business_information', 'live', 1, '2024-10-08 12:42:37', '2024-10-08 12:42:37'),
...
('11d4f10d-2881-4c7d-baa6-e00ff603bc4b', 'social_media', '[{\"id\":\"c96083cd-cbb0-415b-a215-b77da4c293c9\",\"media\":\"facebook\",\"link\":\"https:\\/\\/www.facebook.com\",\"status\":1},{\"id\":\"8cc641e5-019d-4760-b912-efa39d937635\",\"media\":\"instagram\",\"link\":\"https:\\/\\/www.instagram.com\",\"status\":1},{\"id\":\"0f104f7c-f0cb-4933-b35b-c04f829a682d\",\"media\":\"linkedin\",\"link\":\"https:\\/\\/www.linkedin.com\",\"status\":1},{\"id\":\"793d22b1-aa6a-48c3-a654-47dc799532a7\",\"media\":\"youtube\",\"link\":\"https:\\/\\/www.youtube.com\",\"status\":1}]', '[{\"id\":\"c96083cd-cbb0-415b-a215-b77da4c293c9\",\"media\":\"facebook\",\"link\":\"https:\\/\\/www.facebook.com\"},{\"id\":\"8cc641e5-019d-4760-b912-efa39d937635\",\"media\":\"instagram\",\"link\":\"https:\\/\\/www.instagram.com\"},{\"id\":\"0f104f7c-f0cb-4933-b35b-c04f829a682d\",\"media\":\"linkedin\",\"link\":\"https:\\/\\/www.linkedin.com\"},{\"id\":\"793d22b1-aa6a-48c3-a654-47dc799532a7\",\"media\":\"youtube\",\"link\":\"https:\\/\\/www.youtube.com\"}]', 'landing_social_media', 'live', 0, '2023-08-30 19:27:38', '2025-08-23 16:10:54'),
...
('bb1b788c-fb60-468f-a636-68b6c84326cd', 'repeat_booking', '0', NULL, 'booking_setup', 'live', 1, '2024-11-19 15:53:49', '2024-11-19 15:53:49'),
...
CREATE TABLE `carts` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  `is_guest` tinyint(1) NOT NULL DEFAULT '0',
  `coupon_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `categories` (`id`, `parent_id`, `name`, `slug`, `image`, `position`, `description`, `is_active`, `is_featured`, `created_at`, `updated_at`) VALUES
('5e5c0fdb-9ad7-4075-bcc1-d7523efde8c6', '0', 'Test category', 'test-category', '2023-08-31-64ef394fcd699.png', 1, NULL, 1, 1, '2023-08-30 19:42:55', '2026-02-05 10:31:49'),
('b4fcd6d4-ba80-4e20-9ee2-f07a8b1466c6', '5e5c0fdb-9ad7-4075-bcc1-d7523efde8c6', 'Test Sub category', 'test-sub-category', '2023-08-31-64ef3983e4faa.png', 2, 'This is a fake description', 1, 0, '2023-08-30 19:43:47', '2026-02-05 10:31:49');
...
CREATE TABLE `cron_jobs` (
  `id` bigint UNSIGNED NOT NULL,
  `title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `send_mail_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `send_mail_day` int NOT NULL DEFAULT '1',
  `activity` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `php_file_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `cron_jobs` (`id`, `title`, `send_mail_type`, `send_mail_day`, `activity`, `php_file_path`, `command`, `status`, `created_at`, `updated_at`, `type`) VALUES
...
('17c85ec4-3267-43db-8bae-4682542e8117', NULL, '192.168.50.57', '2024-11-19 15:49:22', '2024-11-19 15:49:22', 'en'),
('e1b8ea80-a6ea-4a4d-96f5-caf98c7a92a4', NULL, '192.168.50.57', '2024-11-19 15:49:05', '2024-11-19 15:49:05', 'en');
...
(200, '2024_10_17_123023_create_booking_repeats_table', 60),
(201, '2024_10_19_103658_add_to_col_bookings_table', 60),
(202, '2024_10_19_133157_create_booking_repeat_details_table', 60),
(203, '2024_10_21_141011_add_to_col_carts_table', 60),
(204, '2024_10_21_174902_add_to_col_booking_details_amounts_table', 60),
(205, '2024_10_22_115400_add_to_col_booking_schedule_histories_table', 60),
(206, '2024_10_22_115502_add_to_col_booking_status_histories_table', 60),
...
(217, '2025_07_10_124538_create_business_page_settings_table', 63),
(218, '2025_07_14_200727_create_settings_tutorials_table', 63),
(219, '2025_07_15_153339_create_providers_withdraw_methods_data_table', 63),
(220, '2025_07_22_145850_add_cover_image_in_providers_table', 63),
(221, '2025_07_26_161742_add_key_type_column_in_notification_setups_table', 63),
(222, '2025_08_20_102246_add_response_to_route_search_histories_table', 63),
(223, '2025_09_03_172258_create_ai_settings_table', 64),
(224, '2025_09_03_202802_create_ai_setting_logs_table', 64),
(225, '2026_01_13_125810_add_slug_col_to_categories_table', 65),
(226, '2026_01_14_161318_add_slug_col_to_services_table', 65);
...
INSERT INTO `notification_setups` (`id`, `user_type`, `title`, `sub_title`, `key`, `value`, `created_at`, `updated_at`, `key_type`) VALUES
('10b69552-ad4f-45ed-9b90-5cf6a4faa567', 'provider', 'Terms & Conditions', 'Choose how the provider will get notified of Terms & Conditions Update by the admin', 'terms_&_conditions_update', '{\"email\":null,\"notification\":1,\"sms\":null}', '2024-08-25 14:24:01', '2025-08-23 16:10:54', 'business_page'),
('13af7141-50e0-49f7-9f5d-4817868f7b74', 'provider', 'Verification', 'Choose how the provider will get notified of Email/Phone Verification and password recovery OTP sent via Email/Phone', 'verification', '{\"email\":1,\"notification\":null,\"sms\":1}', '2024-08-25 14:24:01', '2025-08-23 16:10:54', 'authentication'),
('2a3c95eb-7a13-4a8a-8557-1a57b3e678c0', 'user', 'Refer & earn', 'Choose how the customer will get notified of refer code use, first booking completion, and get cashback as a reward', 'refer_earn', '{\"email\":null,\"notification\":1,\"sms\":null}', '2024-08-25 14:24:01', '2025-08-23 16:10:54', 'wallet'),
('32aa144f-0d86-43c8-93d4-8c649ef0ae30', 'provider', 'System Update', 'Choose how the provider will get notified of System Updates by the admin', 'system_update', '{\"email\":1,\"notification\":null,\"sms\":null}', '2024-08-25 14:24:01', '2025-08-23 16:10:54', 'system'),
('3b56cfeb-7e9b-454f-8fad-813fb255b6d7', 'provider', 'Transaction', 'Choose how the provider will get notified of suspend on exceeding cash in hand balance', 'transaction', '{\"email\":null,\"notification\":1,\"sms\":null}', '2024-08-25 14:24:01', '2025-08-23 16:10:54', 'transaction'),
('3c1757b1-21fd-42ab-9371-71a9ed4c27a6', 'user', 'Verification', 'Choose how the customer will get notified of Email/Phone Verification and password recovery OTP sent via Email/Phone', 'verification', '{\"email\":1,\"notification\":null,\"sms\":1}', '2024-08-25 14:24:01', '2025-08-23 16:10:54', 'authentication'),
('525804e0-4985-4ff5-8d14-dc12c72636c5', 'user', 'Privacy policy update', 'Choose how the customer will get notified of Privacy policy updates by the admin', 'privacy_policy_update', '{\"email\":null,\"notification\":1,\"sms\":null}', '2024-08-25 14:24:01', '2025-08-23 16:10:54', 'business_page'),
('55e98f67-b05c-4419-9ba7-fd2451b346cb', 'user', 'Loyalty point', 'Choose how the customer will get notified of earning loyalty points as a reward', 'loyality_point', '{\"email\":null,\"notification\":1,\"sms\":null}', '2024-08-25 14:24:01', '2025-08-23 16:10:54', 'wallet'),
('57afaffe-b68d-48ed-9494-a7af0000620c', 'provider', 'Booking', 'Choose how the providers will get notified of new bookings, Booking Edits, Booking Status updates, Schedule time changes, and withdrawal request', 'booking', '{\"email\":null,\"notification\":1,\"sms\":null}', '2024-08-25 14:24:01', '2025-08-23 16:10:54', 'booking'),
('59c019e4-1f65-42e3-a1ec-ff1b0e7ae408', 'user', 'Wallet', 'Choose how the customer will get notified of getting a bonus & Wallet balance from admin or add funds by himself', 'wallet', '{\"email\":null,\"notification\":1,\"sms\":null}', '2024-08-25 14:24:01', '2025-08-23 16:10:54', 'wallet'),
('628c0ac6-9339-48de-8ea7-03ee57333fca', 'serviceman', 'Booking', 'Choose how the serviceman will get notified of new booking assign, Booking Edits, Booking Status updates, Schedule time changes', 'booking', '{\"email\":null,\"notification\":1,\"sms\":null}', '2024-08-25 14:24:01', '2025-08-23 16:10:54', 'booking'),
('64b779e6-835d-429c-9ad3-854e5b504385', 'user', 'Chatting', 'Choose how the customer will get notified of message reply, attachment received', 'chatting', '{\"email\":null,\"notification\":1,\"sms\":null}', '2024-08-25 14:24:01', '2025-08-23 16:10:54', 'message'),
('69545df6-cf1a-4021-84b3-be6ed84bd294', 'provider', 'Registration', 'Choose how the provider will get notified of new registration approval or deny', 'registration', '{\"email\":1,\"notification\":null,\"sms\":null}', '2024-08-25 14:24:01', '2025-08-23 16:10:54', 'registration'),
('8754b5d8-00a7-4926-bf4e-c993c84162ce', 'user', 'Terms & Conditions', 'Choose how the customer will get notified of Terms & Conditions Update by the admin', 'terms_&_conditions_update', '{\"email\":null,\"notification\":1,\"sms\":null}', '2024-08-25 14:24:01', '2025-08-23 16:10:54', 'business_page'),
('8dd14f5b-331a-4b84-8721-f3d26e8d7c18', 'provider', 'Subscription', 'Choose how the provider will get notified of the Subscription plan subscribe, shifted, renewed, canceled & updated.', 'subscription', '{\"email\":1,\"notification\":null,\"sms\":null}', '2024-08-25 14:24:01', '2025-08-23 16:10:54', 'subscription'),
('8fe761a7-7201-4942-9bf5-2797f22e37d2', 'user', 'Registration', 'Choose how the customer will get notified when the admin registers the customer to the system', 'registration', '{\"email\":1,\"notification\":null,\"sms\":null}', '2024-08-25 14:24:01', '2025-08-23 16:10:54', 'registration'),
('9090438b-a017-4175-a97a-cc969c8c4f27', 'provider', 'Chatting', 'Choose how the provider will get notified of message reply, attachment received', 'chatting', '{\"email\":null,\"notification\":1,\"sms\":null}', '2024-08-25 14:24:01', '2025-08-23 16:10:54', 'message'),
('9a074e1a-e3b3-4b8f-b7c4-2cc142e66170', 'serviceman', 'Verification', 'Choose how the serviceman will get notified of password recovery OTP sent via Email/Phone', 'verification', '{\"email\":1,\"notification\":null,\"sms\":1}', '2024-08-25 14:24:01', '2025-08-23 16:10:54', 'authentication'),
('a094b687-cafb-47d2-855e-8ec70f87aa67', 'provider', 'Advertisement', 'Choose how the provider will get notified of advertisement requests accept, deny, run ads, expire ads, etc.', 'advertisement', '{\"email\":null,\"notification\":1,\"sms\":null}', '2024-08-25 14:24:01', '2025-08-23 16:10:54', 'advertisement'),
('b01ecf87-2912-4227-90c5-9a99c4f632db', 'serviceman', 'Privacy policy update', 'Choose how the serviceman  will get notified of Privacy policy updates by the admin', 'privacy_policy_update', '{\"email\":null,\"notification\":1,\"sms\":null}', '2024-08-25 14:24:01', '2025-08-23 16:10:54', 'business_page'),
('d9e4cc60-afe8-4160-b536-9eecda300b92', 'serviceman', 'Terms & Conditions Update', 'Choose how the serviceman will get notified of Terms & Conditions Update by the admin', 'terms_&_conditions_update', '{\"email\":null,\"notification\":1,\"sms\":null}', '2024-08-25 14:24:01', '2025-08-23 16:10:54', 'business_page'),
('ed11392c-cbba-468e-aeec-a6fdc28f1f5c', 'provider', 'Privacy policy update', 'Choose how the provider will get notified of Privacy policy updates by the admin', 'privacy_policy_update', '{\"email\":null,\"notification\":1,\"sms\":null}', '2024-08-25 14:24:01', '2025-08-23 16:10:54', 'business_page'),
('edaadfd7-864e-4070-a71f-527f676df127', 'serviceman', 'Chatting', 'Choose how the serviceman will get notified of message reply, attachment received', 'chatting', '{\"email\":null,\"notification\":1,\"sms\":null}', '2024-08-25 14:24:01', '2025-08-23 16:10:54', 'message'),
('f2e260a1-325b-4471-af26-cdc7cb43f899', 'user', 'Booking', 'Choose how the customer will get notified of all the bookings they placed in the system', 'booking', '{\"email\":1,\"notification\":1,\"sms\":null}', '2024-08-25 14:24:01', '2025-08-23 16:10:54', 'booking');
...
--
-- Table structure for table `providers_withdraw_methods_data`
--

CREATE TABLE `providers_withdraw_methods_data` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `provider_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `withdrawal_method_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `method_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `method_field_data` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `is_default` tinyint(1) NOT NULL DEFAULT '0',
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
CREATE TABLE `provider_notification_setups` (
  `id` bigint UNSIGNED NOT NULL,
  `provider_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `notification_setup_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `value` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `review_replies` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `readable_id` bigint DEFAULT NULL,
  `user_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `review_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `route_search_histories` (
  ...
  `route_uri` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `route_full_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `keyword` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `services` (`id`, `name`, `slug`, `short_description`, `description`, `cover_image`, `thumbnail`, `category_id`, `sub_category_id`, `tax`, `order_count`, `is_active`, `rating_count`, `avg_rating`, `min_bidding_price`, `deleted_at`, `created_at`, `updated_at`) VALUES
('f4d44b69-9b28-4c3c-8956-1c223367dd3a', 'Test Service', 'test-service', 'This is a fake short description for the test service.', '<p>This is a fake long description for test service. In the real service, valid informations will be given here.</p>', '2023-08-31-64ef3a3e696a2.png', '2023-08-31-64ef3a3e6d6c0.png', '5e5c0fdb-9ad7-4075-bcc1-d7523efde8c6', 'b4fcd6d4-ba80-4e20-9ee2-f07a8b1466c6', 10.000, 0, 1, 0, 0.0000, 97.000, NULL, '2023-08-30 19:46:54', '2026-02-05 10:31:49');
...
--
-- Table structure for table `settings_tutorials`
--
...
--
-- Indexes for table `booking_ignores`
--
ALTER TABLE `booking_ignores`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `booking_repeats`
--
ALTER TABLE `booking_repeats`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `booking_repeat_details`
--
ALTER TABLE `booking_repeat_details`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `booking_repeat_histories`
--
ALTER TABLE `booking_repeat_histories`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `business_page_settings`
--
ALTER TABLE `business_page_settings`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `business_page_settings_page_key_unique` (`page_key`),
  ADD UNIQUE KEY `business_page_settings_title_unique` (`title`);
...
--
-- Indexes for table `providers_withdraw_methods_data`
--
ALTER TABLE `providers_withdraw_methods_data`
  ADD PRIMARY KEY (`id`),
  ADD KEY `providers_withdraw_methods_data_provider_id_index` (`provider_id`),
  ADD KEY `providers_withdraw_methods_data_withdrawal_method_id_index` (`withdrawal_method_id`);
...
--
-- Indexes for table `settings_tutorials`
--
ALTER TABLE `settings_tutorials`
  ADD PRIMARY KEY (`id`),
  ADD KEY `settings_tutorials_user_id_index` (`user_id`);
...
--
-- AUTO_INCREMENT for table `booking_ignores`
--
ALTER TABLE `booking_ignores`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `booking_repeat_histories`
--
ALTER TABLE `booking_repeat_histories`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
