...
--
-- Host: localhost:3306
-- Generation Time: Jan 23, 2025 at 05:03 AM
...
CREATE TABLE `booking_details_amounts` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `booking_repeat_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `booking_repeat_details_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `booking_offline_payments` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `booking_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `offline_payment_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `payment_status` enum('pending','denied','approved') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'approved',
...
CREATE TABLE `booking_repeats` (
  ...
  `readable_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `booking_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `booking_details_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `provider_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `serviceman_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `evidence_photos` longtext COLLATE utf8mb4_unicode_ci,
  `booking_otp` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `carts` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  `is_guest` tinyint(1) NOT NULL DEFAULT '0',
  `coupon_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `cron_jobs` (
  `id` bigint UNSIGNED NOT NULL,
  `title` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `send_mail_type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `send_mail_day` int NOT NULL DEFAULT '1',
  `activity` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `php_file_path` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
